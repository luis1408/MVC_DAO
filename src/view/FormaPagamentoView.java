...
public class FormaPagamentoView extends javax.swing.JFrame {
    ...
    private ArrayList<FormaPagamentoModel> lista;
    private FormaPagamentoTableModel tabela;
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Forma de Pagamento MVC");
        getContentPane().add(lblTitulo);
        lblTitulo.setBounds(180, 80, 340, 29);
        ...
        jTabbedPane1.addTab("Forma de Pagamento", painelDADOS);

        getContentPane().add(jTabbedPane1);
        jTabbedPane1.setBounds(20, 120, 700, 140);
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(83, 83, 83)))
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(edtCONS_NOME, javax.swing.GroupLayout.PREFERRED_SIZE, 324, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void mostrar(FormaPagamentoModel formapagamento) {
        edtFPG_CODIGO.setText(String.valueOf(formapagamento.getFpg_codigo()));
        edtFPG_NOME.setText(formapagamento.getFpg_nome());
        chkFPG_ATIVO.setSelected((formapagamento.getFpg_ativo() == 1));
    }
    ...
    private void btnGRAVARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGRAVARActionPerformed
        if (JOptionPane.showConfirmDialog(null, "Confirma Gravação deste Usuário ?",
            ...
            try {
                ...
                objformapagamento.setFpg_codigo(Integer.parseInt(edtFPG_CODIGO.getText()));
                objformapagamento.setFpg_nome(edtFPG_NOME.getText());
                objformapagamento.setFpg_ativo((chkFPG_ATIVO.isSelected() ? 1 : 0));
                FormaPagamentoController formapagamentocontroller = new FormaPagamentoController();
                formapagamentocontroller.gravar(getOperacao(), objformapagamento);
    ...
    private void btnEXCLUIRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEXCLUIRActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Confirma Exclusão deste Registro ?",
            ...
            try {
                ...
                FormaPagamentoController formapagamentocontroller = new FormaPagamentoController();
                formapagamentocontroller.excluir(objformapagamento);
